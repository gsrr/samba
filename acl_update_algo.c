...
int main(int argc,char *argv[]) { 
    ...
    int enableREAD = atoi(argv[6]);
    num = atoi(argv[7]);
    inum = atoi(argv[8]);
    aclnum = atoi(argv[9]);

    printf("args: debug=%d, mode=%d, files=%d, acl=%d, setxattr=%d, getxattr=%d, num=%d, inum=%d, aclnum=%d\n", debug, mode, files, enableACL, enableSET, enableREAD, num, inum, aclnum);
...
*/
    ...
    for (i = 0 ; i < files ; i++)
    {
        ...
        fsetxattr(fd, "user.test1", "", 256, XATTR_CREATE);
        if(mode == 1)
        ...
        */
        ...
        {
            char value[256];
            fgetxattr(fd, "user.test1", value, 256);
            
        }
        if(enableSET == 1)
        {
            fsetxattr(fd, "user.test1", "", 256, XATTR_REPLACE);
        }
        close(fd); 
    } 
    printf("Elapse:%f\n", total_time/1000000);
